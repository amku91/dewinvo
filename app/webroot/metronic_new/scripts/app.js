        ...
        jQuery('.page-sidebar').on('click', 'li > a', function (e) {
                ...
                if (sub.is(":visible")) {
                    ...
                    sub.slideDown(200, function () {
                            handleSidebarAndContentHeight();
                            //$('.page-sidebar-menu').slimScroll({scrollTo: sub.children().first().offset().top-70, animate: true});
                        });
...
//        });
    ...
    return {
        ...
        blockUI: function (el, centerY) {
        	var el = jQuery(el); 
        	el.block({
        		message: '<img src="'+GLOBAL_PATH+'metronic_new/img/ajax-loading.gif" align="">',
